...
<div class="page__top-panel">
    ...
    <div class="container">
        <div class="page__top-panel__in">
            <h1 class="page__top-panel__title"> ПРОЕКТИРОВАНИЕ МАГИСТРАЛЬНЫХ ИНЖЕНЕРНЫХ СЕТЕЙ (ИСКЛЮЧАЯ
                МАГИСТРАЛЬНЫЕ
                ГАЗОПРОВОДЫ, НЕФТЕПРОВОДЫ И НЕФТЕПРОДУКТОПРОВОДЫ).
        ...
        <div class="section__in">
            <div class="section__content">
                <h2 class="sm-gl-title first-animation">
                    <span>01</span>
                    <small>ПРОЕКТИРОВАНИЕ МАГИСТРАЛЬНЫХ ИНЖЕНЕРНЫХ СЕТЕЙ (ИСКЛЮЧАЯ МАГИСТРАЛЬНЫЕ
                        ГАЗОПРОВОДЫ, НЕФТЕПРОВОДЫ И НЕФТЕПРОДУКТОПРОВОДЫ).
                        ПРОЕКТИРОВАНИЕ АВТОМОБИЛЬНЫХ ДОРОГ</small>
                </h2>
